...
const badges = [
  {
    id: 1,
    title: 'Get started',
    description: 'Use our hosted version and get started in minutes',
    icon: Rocket,
                  ...
                  >
                    ...
                    <div>
                      <div className="flex gap-2 items-center">
                        <h3 className="text-foreground font-medium">{badge.title}</h3>
            ...
            {supportCards.map((card) => {
              ...
              return (
                ...
                >
                  ...
                  <h2 className="text-foreground font-medium mt-2">{card.title}</h2>
